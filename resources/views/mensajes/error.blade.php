        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><span>Sabor a U</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="app/img/perfil.jpg" alt="..." class="img-circle profile_img">
              </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Pedidos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Pedidos del día</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="app/img/perfil.jpg" alt="">Sophía
         ...
         <div class="right_col" role="main">
          ...
          <div class="col-md-10 col-xs-10 col-sm-10">
            <div class="alert alert-danger">
              <strong>Acceso denegado</strong> No tiene los suficientes privilegios para acceder a esta sección.
            </div>
          </div>
        </div>
