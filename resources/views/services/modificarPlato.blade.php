...
<div class="col-md-6 col-sm-6 col-xs-6 selectPlatos">
  ...
  <div class="col-md-4 col-sm-4 col-xs-4 form-group">
    <select class="form-control" id="selPlato" name="semana" onchange="cargarDatosPlato(this.value);">
    </select>
  </div>
</div>
<div class="row" id="contenedorPrincipal" style="visibility: hidden;">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="col-md-6 col-sm-6 col-xs-6 selectDias">
      <h2>Día:</h2>            
        <div class="col-md-4 col-sm-4 col-xs-4 form-group ">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 selectSemana">
      <h2>Semana:</h2>
      <div class="col-md-4 col-sm-4 col-xs-4 form-group">
...
<script>
  ...
  function obtenerDatos(){
    ...
    var idPlato = $('#selPlato').val();

    if(datosValidos()){
      modificarPlato(plato, idPlato);
